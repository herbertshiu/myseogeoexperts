  ...
  return (
    <footer className="publication-footer">
      ...
      <div className="footer-grid">
        <div className="footer-brand-block"><Link href="/" className="brand brand--footer" aria-label="myseogeoexperts home"><span className="brand-mark" aria-hidden="true"><img src="/manus-storage/harbour-ledger-mark_168ca4fe.png" alt="" /><span /></span><span className="brand-name">myseogeo<span>experts</span></span></Link><p>{isChinese ? "給香港企業的搜尋、地圖和機器答案曝光指南。" : "A field guide for Hong Kong companies building visibility across search, maps, and machine answers."}</p></div>
